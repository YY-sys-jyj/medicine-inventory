...
alter table public.notification_events add column if not exists wxpusher_sent_at timestamptz;
alter table public.notification_events add column if not exists wxpusher_error text;
alter table public.notification_events add column if not exists pushplus_sent_at timestamptz;
alter table public.notification_events add column if not exists pushplus_error text;
...
create index if not exists idx_wechat_bindings_uid on public.wechat_bindings(wxpusher_uid);
alter table public.wechat_bindings enable row level security;
alter table public.wechat_bindings add column if not exists pushplus_token text default '';
alter table public.wechat_bindings add column if not exists pushplus_enabled boolean not null default false;
alter table public.wechat_bindings alter column wxpusher_uid drop not null;
alter table public.wechat_bindings alter column wxpusher_uid set default '';
